...
import static app.jyu.SophisticatedPing.Vec3dToVector3d;
import static app.jyu.SophisticatedPingClient.pingKeyBinding;
...
public class RenderHandler {
    ...
    private static final Identifier PING_BASIC = new Identifier(SophisticatedPing.MOD_ID, "textures/ping/ping_basic.png");
    ...
    private static Vec3d map(double anglePerPixel, Vec3d cameraDir, Vector3f horizontalRotationAxis,
        ...
        final Vector3f temp2 = SophisticatedPing.Vec3dToV3f(cameraDir);
    ...
    public static Vec3d XY2Vec3d(Vector2i xy) {
        ...
        Vector3f verticalRotationAxis = SophisticatedPing.Vec3dToV3f(cameraDirection);
        verticalRotationAxis.cross(new Vector3f(0, 1, 0));
        verticalRotationAxis.normalize();
        Vector3f horizontalRotationAxis = SophisticatedPing.Vec3dToV3f(cameraDirection);
        horizontalRotationAxis.cross(verticalRotationAxis);
        horizontalRotationAxis.normalize();
        verticalRotationAxis = SophisticatedPing.Vec3dToV3f(cameraDirection);
