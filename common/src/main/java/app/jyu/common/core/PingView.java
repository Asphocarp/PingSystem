...
import static app.jyu.common.config.ClientConfig.*;
	...
	public void playSoundInDimension() {
		...
		Game.getSoundManager().play(
			new DirectionalSoundInstance(
				IPlatformSoundService.INSTANCE.sound("ping"),
				SoundSource.MASTER,
